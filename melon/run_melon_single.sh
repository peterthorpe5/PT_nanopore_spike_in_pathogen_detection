...
THREADS="${THREADS:-12}"
SAMPLE_NAME="${SAMPLE_NAME:-single_genome_test}"
...
OUT_DIR="${OUT_DIR:-/home/pthorpe001/data/2026_plasmodium_kraken_sensitivity/runs/melon_single_$(date +%Y%m%d_%H%M%S)}"
