...
REPO_DIR="${REPO_DIR}" PY_SCRIPTS_DIR="${PY_SCRIPTS_DIR}" PATHOGEN_FASTA="${SHUFFLED_FASTA}" OUT_DIR="${OUT_DIR}/main_run" bash "${SHELLS_DIR}/run_spikein_single_readlevel.sh"
