...
RUN_SCRIPT="${RUN_SCRIPT:-${SHELLS_DIR}/run_spikein_single_flye.sh}"
...
export OUT_DIR="${OUT_DIR:-${PROJECT_DIR}/runs/spikein_single_flye_rerun_$(date +%Y%m%d_%H%M%S)}"

log_info "Project dir: ${PROJECT_DIR}"
log_info "Repo dir: ${REPO_DIR}"
log_info "Using run script: ${RUN_SCRIPT}"
log_info "Output dir: ${OUT_DIR}"
log_info "Submitting single-genome Flye assembly rerun"

bash "${RUN_SCRIPT}"

log_info "Single-genome Flye rerun finished"
log_info "Output dir: ${OUT_DIR}"
