...
KRAKEN_DB_DIR_DEFAULT="${KRAKEN_DB_DIR_DEFAULT:-${DB_BASE}/kraken_bact_virus_plasmo_fungal}"
...
METAMAPS_DB_DIR_DEFAULT="${METAMAPS_DB_DIR_DEFAULT:-${DB_BASE}/metamaps/current/custom_metamaps_db}"
